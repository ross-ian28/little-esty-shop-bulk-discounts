...
RSpec.describe Customer, type: :model do
  ...
  before do
    ...
    it "#top_five_customers" do
      expect(Customer.top_five_customers).to eq([@customer, @customer_2, @customer_3, @customer_4, @customer_5])
    end
  end
  describe 'instance methods' do
    ...
    it "#full_name" do
      expect(@customer.full_name).to eq("Joey Smith")
    end

    it '#succsessful_transaction_count' do
      expect(@customer.succsessful_transaction_count).to eq(2)
    end
  end
end
